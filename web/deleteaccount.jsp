            ...
            <c:when test="${user != null}">
                ...
                <section>
                    <div class="center sign_form form-group">
                        <form class="form-signin signInFrm" method="post" action="deleteaccountsubmit">
                            <fieldset>
                                <legend class="legend signInh2"> Delete your Account </legend>
                                ${errMsg1}
                                <div class="form-group ${border1}">
                                    <label for="oldpass" value="${pass1}" class="sr-only">Password</label>
                                    <input type="password" id="oldpass" name="oldpass" class="form-control" placeholder="Password"
                                           required autofocus>
                                </div>
                                ${errMsg2}
                                <div class="form-group  ${border2}">
                                    <label for="checknewpass" class="sr-only">Confirm Password</label>
